...
//    Отправить на проверку
    ...
    public Set<Integer> getAllFriendsAndPotentialFriends(int index, int deep) { //работает неправильно
        Set<Integer> result = new HashSet<>();

        // direct friends search
        ...
        if (deep > 1) {
            ...
            for (Integer directFriend : temp) {
                // Проход по всем друзьям для добавления их друзей (след уровень)
                result.addAll(getAllFriendsAndPotentialFriends(directFriend, deep - 1));
            }
        }
