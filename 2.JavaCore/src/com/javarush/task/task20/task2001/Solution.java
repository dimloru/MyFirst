...
//            String your_file_name = args[0];
            ...
            if (somePerson.equals(ivanov)) System.out.println("YES!!!");
...
//            outputStream.write(30);
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            String line;
            String price;
            while (!(line = reader.readLine()).equals("...HumanSeparator...")) {
                price = reader.readLine();
                this.assets.add(new Asset(line, Double.parseDouble(price)));
            }
        }
    }
}
