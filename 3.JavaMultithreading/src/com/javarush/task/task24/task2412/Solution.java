...
public class Solution {
    ...
    public static void printStocks(List<Stock> stocks, Date actualDate) {
        ...
        double[] filelimits = {0d, actualDate.getTime()};  // до сегодняшнего дня
        String[] filepart = {"closed {4}", "open {2} and last {3}"};

        ChoiceFormat fileform = new ChoiceFormat(filelimits, filepart);
        Format[] testFormats = {null, null, dateFormat, fileform}; //formats to format elements in the Pattern string
        MessageFormat pattform = new MessageFormat("{0}   {1} | {5} {6}"); // Pattern string
        pattform.setFormats(testFormats); // Sets the formats to use for the format elements in the previously set pattern string.
    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            ...
            public int compare(Stock stock1, Stock stock2) {
                if (stock1 == null || stock2 == null) return 0; //null check
    ...
    public static class Stock extends HashMap {
        public Stock(String name, String symbol, double open, double last) {
            ...
            //my addition in order to compare, calculation change
            put("change", last - open);
        }
