    ...
    public synchronized String getPartOfString(String string, String threadName) {
        try {
            ...
            if (threadName.equals(FIRST_THREAD_NAME)) {
                TooShortStringFirstThreadException my = new TooShortStringFirstThreadException();
                my.initCause(e);
                throw my;
            }
            else if (threadName.equals(SECOND_THREAD_NAME)) {
                TooShortStringSecondThreadException my = new TooShortStringSecondThreadException();
                my.initCause(e);
                throw my;
            }
            else {
                RuntimeException my = new RuntimeException();
                my.initCause(e);
                throw my;
            }
        }
